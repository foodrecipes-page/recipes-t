...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 't'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-t@main/recipes/<cuisine>/<diet>/<slug>.json
```
